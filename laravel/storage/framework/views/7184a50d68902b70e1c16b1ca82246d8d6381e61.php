	...
	<div class="col-md-10">
		...
		<div class="panel panel-default">
			...
			<form action="/admin/sys/config" method="post">
				...
				<div class="form-group">
					<label for="">关键字</label>
					<input type="text" name="keywords" class="form-control"  value="<?php echo e(config('web.keywords')); ?>"  placeholder="请输入友情链接">
				</div>
				<div class="form-group">
					<label for="">描述</label>
					<input type="text" name="description" class="form-control"  value="<?php echo e(config('web.description')); ?>"  placeholder="数值越大越靠前">
				</div>
				<div class="form-group">
					<label for="">统计</label>
					<textarea name="baidu" class="form-control" cols="30" rows="2"><?php echo e(config('web.baidu')); ?></textarea>
				</div>
                ...
                <div class="form-group">
                    ...
                    <div id="upload"></div>
                    <div id="main">
                        <img src="/Uploads/Sys/<?php echo e(config('web.logo')); ?>" width="200px" >
        ...
        <script type="text/javascript">
            ...
            $(function(){
                ...
                $('#upload').Huploadify({
                    ...
                    multi:true,
                    formData:{'_token':'<?php echo e(csrf_token()); ?>','dir':'Sys'},
                    fileSizeLimit:9999,
                    fileObjName:'files',
