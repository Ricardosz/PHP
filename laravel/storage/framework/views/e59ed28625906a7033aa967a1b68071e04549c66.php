    ...
    <script>
        ...
        function status(obj,id,status){
            ...
            if (status) {
                ...
                $.post('/admin/admin/ajaxStatus',{id:id,"_token":"<?php echo e(csrf_token()); ?>","status":"0"},function(data){
                ...
                $.post('/admin/admin/ajaxStatus',{id:id,"_token":"<?php echo e(csrf_token()); ?>","status":"1"},function(data){
