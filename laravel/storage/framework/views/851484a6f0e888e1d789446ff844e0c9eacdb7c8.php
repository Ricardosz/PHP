<?php $__env->startSection('main'); ?>
    ...
    <script>
        ...
        function save(){
            ...
            $.post("/admin/Permissions/1",{str:str,"_method":'put','_token':'<?php echo e(csrf_token()); ?>'},function(data){
        ...
        function status(obj,id,status){
            ...
            if (status) {
                ...
                $.post('/admin/Permissions/ajaxStatus',{id:id,"_token":"<?php echo e(csrf_token()); ?>","status":"0"},function(data){
                ...
                $.post('/admin/Permissions/ajaxStatus',{id:id,"_token":"<?php echo e(csrf_token()); ?>","status":"1"},function(data){
        ...
        function deletes(obj,id){
            ...
            $.post("/admin/Permissions/"+id,{"_token":'<?php echo e(csrf_token()); ?>',"_method":"delete"},function(data){
                // 判断是否成功
        ...
        function add(){
            ...
            $.post('/admin/Permissions',{str:str,'_token':'<?php echo e(csrf_token()); ?>'},function(data){
