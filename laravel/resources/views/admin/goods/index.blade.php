...
@section('main')
    ...
    <div class="col-md-10">
        ...
        <div class="panel panel-default">
            <div class="panel-heading">
                ...
                <p class="pull-right tots" >共有 <span id="tot">{{$data->tot}}</span> 条数据</p>
            ...
            <table class="table-bordered table table-hover">
                ...
                @foreach($data as $value)
                    <tr>
                        ...
                        <td>{{$value->id}}</td>
                        <td>
                            <a href="/admin/Sku?id={{$value->id}}"> {{$value->gname}}</a></td>
                        </td>
                        <td>{{$value->cname}}</td>
                        <td>
    ...
    <script>
        ...
        function save(){
            ...
            $.post("/admin/goods/1",{str:str,"_method":'put','_token':'{{csrf_token()}}'},function(data){
        ...
        function add(){
            ...
            $.post('/admin/goods',{str:str,'_token':'{{csrf_token()}}'},function(data){
