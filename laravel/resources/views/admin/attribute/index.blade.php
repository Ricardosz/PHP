...
@section('main')
        ...
        <div class="panel panel-default">
            <div class="panel-heading">
                ...
                <a href="#" data-toggle="modal" data-target="#add" class="btn btn-success"><span
                            class="glyphicon glyphicon-plus"></span> 添加属性名</a>
            ...
            <table class="table-bordered table table-hover">
                ...
                @foreach($data as $value)
                    <tr>
                        ...
                        <td>{{$value->tname}}</td>
                        <td>
                            <a href="#" onclick="edit({{$value->id}})" data-toggle="modal" data-target="#edit" class="glyphicon glyphicon-pencil"></a>&nbsp;&nbsp;&nbsp;<a href="#" onclick="deletes(this,{{$value->id}})" class="glyphicon glyphicon-trash"></a>
                        </td>
                    </tr>
                @endforeach
            </table>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title">添加商品属性名</h4>
                </div>
                <div class="modal-body">
                    <form action="" onsubmit="return false;" id="formAdd">
                        <div class="form-group">
                            <label for="">商品属性名</label>
                            <input type="text" name="name" class="form-control" placeholder="请输入商品属性名">
                        </div>
                        <div class="form-group">
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal"><span
                                aria-hidden="true">&times;</span><span class="sr-only">Close</span></button>
                    <h4 class="modal-title">修改商品属性名</h4>
                </div>
    ...
    <script>
        ...
        function save() {
            ...
            $.post("/admin/attribute/1", {str: str, "_method": 'put', '_token': '{{csrf_token()}}'}, function (data) {
        ...
        function edit(id) {
            // 发送ajax请求
            $.get("/admin/attribute/" + id + "/edit", {}, function (data) {
                if (data) {
                    $("#body").html(data);
                }
                ;
        ...
        function deletes(obj, id) {
            ...
            $.post("/admin/attribute/" + id, {"_token": '{{csrf_token()}}', "_method": "delete"}, function (data) {
                // 判断是否成功
        ...
        function add() {
            ...
            $.post('/admin/attribute', {str: str, '_token': '{{csrf_token()}}'}, function (data) {
