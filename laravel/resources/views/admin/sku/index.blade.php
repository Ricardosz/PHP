...
@section('main')
    ...
    <div class="col-md-10">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active">商品:{{$data->gname}}--库存列表</li>
            ...
            <table class="table-bordered table table-hover">
                ...
                @foreach($sku as $value)
                    <tr>
                        ...
                        <td>{{$value->num}}</td>
                        <th>{{$value->sales}}</th>
                        <td><a href="#" onclick="edit({{$value->sid}})" data-toggle="modal" data-target="#edit" class="glyphicon glyphicon-pencil"></a>&nbsp;&nbsp;&nbsp;<a href="#" onclick="deletes(this,{{$value->sid}})" class="glyphicon glyphicon-trash"></a></td>
                    </tr>
                @endforeach
            </table>
            <!-- 分页效果 -->
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="" onsubmit="return false;" id="formAdd">
                        ...
                        <div class="form-group">
                            <label for="">商品名</label>
                            <input type="text" name="gname" class="form-control" disabled value="{{$data->gname}}">
                        </div>
                        <div class="form-group">
                            <label for="">商品所属分类</label>
                            <input type="text" name="tname" class="form-control" disabled value="{{$data->tname}}">
                        </div>
                        <div class="form-group">
                            <label for="">商品属性名</label>
                            <input type="text" name="tname" class="form-control" disabled value="{{$data->aname}}">
                        </div>
                        <div class="form-group">
    ...
    <script>
        ...
        function save() {
            ...
            $.post("/admin/Sku/1", {str: str, "_method": 'put', '_token': '{{csrf_token()}}'}, function (data) {
        ...
        function deletes(obj, id) {
            ...
            $.post("/admin/Sku/" + id, {"_token": '{{csrf_token()}}', "_method": "delete"}, function (data) {
                // 判断是否成功
        ...
        function add() {
            ...
            $.post('/admin/Sku', {str: str, '_token': '{{csrf_token()}}'}, function (data) {
