            ...
            <table class="table-bordered table table-hover">
                ...
                @foreach($data as $value)
                    <tr>
                        ...
                        <td><a href="#" onclick="edit({{$value->rid}})" data-toggle="modal" data-target="#edit" class="glyphicon glyphicon-pencil"></a>&nbsp;&nbsp;&nbsp;<a href="#" onclick="deletes(this,{{$value->rid}})" class="glyphicon glyphicon-trash"></a></td>
                    </tr>
                @endforeach
    ...
    <script>
        ...
        function status(obj,id,status){
            ...
            if (status) {
                ...
                $.post('/admin/role/ajaxStatus',{id:id,"_token":"{{csrf_token()}}","status":"0"},function(data){
                ...
                $.post('/admin/role/ajaxStatus',{id:id,"_token":"{{csrf_token()}}","status":"1"},function(data){
        ...
        function deletes(obj,id){
            ...
            $.post("/admin/role/"+id,{"_token":'{{csrf_token()}}',"_method":"delete"},function(data){
                // 判断是否成功
