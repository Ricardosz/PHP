                    ...
                    @foreach($goodsImg as $Img)
                        <li id="bigim0" style="z-index:1;filter: alpha(opacity=100); opacity: 1;">
                            <a href="javascript:;">
                                ...
                                <img src="/Uploads/Goods/{{$Img->img}}" alt="{{$goods->title}}" width="544px"
                                     height="544px">
                            </a>
                        </li>
                    @endforeach
                    ...
                    <ul class="pro_ul" id="imgSmall" style="width: 408px;">
                        @foreach($goodsImg as $Img)
                            <li id="im0" style="filter:alpha(opacity:100);opacity:1;">
                                <a href="javascript:;">
                                    <img src="/Uploads/Goods/{{$Img->img}}" alt="{{$goods->title}}" width="88px"
                                         height="88px">
                                </a>
                            </li>
                        @endforeach
            ...
            <div class="xilei">
                ...
                <div class="btn-group" data-toggle="buttons">
                    ...
                    <label class="btn btn-primary">
                       <input type="radio" name="sid" id="option1" value="{{$val->sid}}">{{$val->value}}
                    </label>
                    @endforeach
                        ...
                        <ul id="pingjia_body" style="display: none;">
                            ...
                            <div class="ns_comment ns_fixClear" id="div3">
                                ...
                                <div id="pager_divdiv3" class="ns_discusspager">
                                    <div class="ns_comment-inner" id="sppl_box">
                                        @if($Evaluation['commentTot'])
                                        <dl id="sppl_title">
                                            <dt>
                                               <b>{{round(($Evaluation['GoodTot']/$Evaluation['commentTot'])*100)}}</b>
                                                <span>&nbsp;%</span>
                                                <p>好评率</p>
                                            </dt>
                                            <dd class="sppl_total active" data-level="0">全部评价(<span>{{$Evaluation['commentTot']}}</span>)</dd>
                                            <dd class="sppl_good" data-level="3">好评(<span>{{$Evaluation['GoodTot']}}</span>)</dd>
                                            <dd class="sppl_medium" data-level="2">中评(<span>{{$Evaluation['GeneralTot']}}</span>)</dd>
                                            <dd class="sppl_total" data-level="1">差评(<span>{{$Evaluation['BadTot']}}</span>)</dd>
