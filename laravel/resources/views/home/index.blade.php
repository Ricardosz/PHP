...
<div class="container search">
    <div class="search-left">
        <a href="http://shuaizai.com"><img src="/Uploads/Sys/{{config('web.logo')}}" alt="" width="200px"></a>
    </div>
                    ...
                    <div class="left-xiang">
                        ...
                        <div class="left-tu">
                           @foreach($one->rightAds as $rightAds)
                            <a href="">
                              <img class="classification_img" title="{{$rightAds->title}}" src="/Uploads/TypesAds/{{$rightAds->img}}">
                            </a>
                               @endforeach
                        </div>
                    </div>
        ...
        <div class="boo">
            <ul class="bo-1">
                @foreach( $ads as $key=>$value)
                    ...
                    <img src="/Uploads/Ads/{{$value->img}}" alt="">
                        </a>
                    </li>
...
>>>>>>> bc22745cc7577ecfc461790f8ac735360a2d4939
                    ...
                    <p class="star_price"><a target="_blank" href="" title="{{$good->title}}">{{number_format($good->price)}}元</a></p>
                </li>
               @endforeach
                <div class='clear'></div>
            </ul>
...
<div class="ceng">
    <div class='container lou '>
        ...
        <div class="lenovo">
            ...
            <div class="rong">
                <div class="zuo">
                   <a target="_blank" href=""> <img title="{{$lou->leftAds->title}}" width="240" height="535" src="/Uploads/TypesAds/{{$lou->leftAds->img}}">
                    </a>
                </div>
                <div class="you">
...
<<<<<<< HEAD
                        ...
                        <a class="good-jie" target="_blank" href="/goods/{{$louGoods->gid}}/{{$louGoods->id}}" title="{{$louGoods->title}}">{{$louGoods->title}}
                        </a>
                        <a class="good-jie1" target="_blank" href="/goods/{{$louGoods->gid}}/{{$louGoods->id}}">
