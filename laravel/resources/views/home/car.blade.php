                    ...
                    <table cellpadding="0" cellspacing="0">
                        ...
                        @foreach($shop as $car)
                            <tr class=" active" gcode="52770" stock="18">
                                ...
                                <td width="163">
                                    <a href="/goods/{{$car['id']}}" target="_blank">{{$car['goodsInfo']->info}}</a>
                                </td>
                                ...
                                <td width="152" text-align:center>
                                    <label class="i_box clearfix">
                                        <input class="pro_less J_minus" type="button" value="-"
                                               ids="{{$car['goodsInfo']->id}}" money="{{$car['goodsInfo']->price}}">
                                        <input class="pro_num J_input" type="text" value="{{$car['num']}}"
                                               val="{{$car['num']}}">
                                ...
                                $tot += $money;
                                ?>
                                <td width="152" class="bc_red" id="money{{$car['goodsInfo']->id}}">{{$money}}</td>
                                <td width="117" style="text-align:left">
                                    <a href="#" style="color: #000" title="删除"
                                       onclick="deleline(this,{{$car['goodsInfo']->id}})">删除</a>
                                    <br>
                ...
                <div class="bc_num clearfix">
                    ...
                    <ul class="bc_num_fr">
                        <!--    <li style="margin-top:0;">商品总价：7499.00 元</li>
                           <li>优惠节省：500.00 元</li> -->
                        <li>合计：<span class="bc_red" id="totalmoneyf"><span id="Total">{{$tot}}</span> 元</span></li>
                    </ul>
                </div>
...
<script>
    ...
    $(".J_minus").click(function () {
        ...
        num = Number(num);
        if (num > 1) {
            $.post("/CarCut", {id: id, "_token": "{{csrf_token()}}"}, function (data) {
                obj.next().val(--num);
                //获取商品的价格
                price = Number(obj.attr("money"));
                //小计发生改变
